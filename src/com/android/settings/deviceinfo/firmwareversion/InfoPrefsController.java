...
import com.serasa.utils.SpecUtils;
...
public class InfoPrefsController extends AbstractPreferenceController implements
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        final LayoutPreference serasaInfoPreference = screen.findPreference(KEY_SERASA_INFO);
        final TextView chipText = (TextView) serasaInfoPreference.findViewById(R.id.chipset_summary);
        final TextView storText = (TextView) serasaInfoPreference.findViewById(R.id.cust_storage_summary);
        final TextView battText = (TextView) serasaInfoPreference.findViewById(R.id.cust_battery_summary);
        final TextView dispText = (TextView) serasaInfoPreference.findViewById(R.id.cust_display_summary);
